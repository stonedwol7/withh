...
INSERT INTO support_partners (id, name, phone, email, gender, age, verification_status, rating, availability_status, bio, specialties, languages, completed_journeys, created_at) VALUES
  ...
  ('00000000-0000-0000-0000-000000000018', 'Maya Singh', '+1 (555) 888-9999', 'maya@withh.com', 'female', 33, 'verified', 4.8, 'available', 'Empathetic support for legal appointments and college admissions. Great with nervous first-timers.', ARRAY['legal','college','interview'], ARRAY['english','hindi'], 19, '2025-05-01T00:00:00Z'),
...
INSERT INTO requests (id, customer_id, category, title, description, meeting_location, destination, date, time, duration, preferred_gender, status, created_at, updated_at) VALUES
  ...
  ('00000000-0000-0000-0000-000000000109', '00000000-0000-0000-0000-000000000006', 'Interview', 'Job Interview Support', 'First interview in years. Need emotional support and help navigating to the office.', '350 Market St, Apt 12', 'TechCorp HQ, 100 Innovation Drive', '2026-06-25', '10:30', '2-4 hours', 'female', 'requested', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),
